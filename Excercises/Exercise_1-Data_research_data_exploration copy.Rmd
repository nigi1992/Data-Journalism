...
# Load Csv file
referendums <- read.csv('/Users/nicolaswaser/New-project-GitHub-first/R/Data Journalism/Excercises/DATASET EX1 - 09-02-2025.csv', 
                        sep = ";", 
                        header = TRUE, 
...
# Inspect the data
str(referendums)
typeof(referendums$anahme)
str(referendums$annahme)
# Convert 'annahme' to a factor variable
referendums$annahme <- as.factor(referendums$annahme)

# Visualize the number of accepted vs. the number of rejected referendums in dataset
ggplot(referendums, aes(x = annahme)) +
  geom_bar(position = "dodge") +
  labs(title = "Accepted vs. Rejected Referendums in Switzerland",
       x = "Angenommen",
